...
if env["platform"] == "linux":
    ...
    target_path = "libmyplugin." + env["TARGET_ARCH"] + ".so"
    ...
    target_path = "libmyplugin.macos.dylib"
    ...
    target_path = "libmyplugin.ios." + env["ios_arch"] + ".dylib"
    ...
    target_path = "libmyplugin.win" + env["bits"] + ".dll"
    ...
    target_path = "libmyplugin.android." + env["android_arch"] + ".so"
    ...
    target_path = "libmyplugin.wasm" + "32" + ".wasm"
